...
<div class="min-h-screen bg-white flex justify-center items-center py-12">
    <div class="bg-white border border-gray-300 p-8 rounded-lg shadow-xl max-w-4xl w-full">
                ...
                @foreach($users as $user)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-2 px-4 border-b">
                            <form action="{{ route('admin.users.updateRole', ['id' => $user->id]) }}" method="POST" class="flex items-center space-x-2">
                                @csrf
                                @method('PUT')
